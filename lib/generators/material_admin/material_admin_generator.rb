...
class MaterialAdminGenerator < Rails::Generators::NamedBase
  ...
  JS_PKGS  =
    'datatables.net datatables.net-bs5 datatables.net-responsive datatables.net-responsive-bs5'\
    'datatables.net-select-bs5 datatables.net-buttons'\
    ' expose-loader@1.0.3 file-loader url-loader resolve-url-loader'\
    ' @rails/ujs @rails/activestorage'\
    ' stimulus turbolinks'\
    ' jquery popper.js select2 @popperjs/core webpack-cli@3.3.12'\
